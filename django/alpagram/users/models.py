...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, email, password, name, nickname=None, **extra_fields):
        ...
        return self._create_user(email, password, name, nickname=None, **extra_fields)
...
#     img = models.ImageField(upload_to="profile/", default="profile/default.png", verbose_name="프로필이미지")
